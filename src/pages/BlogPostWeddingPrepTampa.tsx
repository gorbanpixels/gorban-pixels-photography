...
const BlogPostWeddingPrepTampa = () => {
  return (
...
{/* Category and Date */}
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm">Dec 20, 2024 • Written By Gorban Pixels</p>
      </div>

      {/* Title */}
      <h1 className="text-4xl md:text-5xl font-light text-gray-900 mb-8 leading-tight">
        Wedding Prep Made Simple | The ULTIMATE How-To Guide
      </h1>

      {/* Hero Image Gallery */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
        <img
          src="https://ik.imagekit.io/f9opvmhvz/Photo_55.png"
          alt="Beautiful Newly Weds"
          className="w-full h-64 object-cover rounded-lg"
        />
        <img
          src="https://ik.imagekit.io/f9opvmhvz/Photo_132.png"
          alt="First Look"
          className="w-full h-64 object-cover rounded-lg"
        />
        <img
          src="https://ik.imagekit.io/f9opvmhvz/Photo_133.png"
          alt="Downtown Tampa"
          className="w-full h-64 object-cover rounded-lg"
        />
        <img
          src="https://ik.imagekit.io/f9opvmhvz/Photo_54.png"
          alt="Send off photos"
          className="w-full h-64 object-cover rounded-lg"
        />
        <img
          src="https://ik.imagekit.io/f9opvmhvz/Photo_60.png"
          alt="Father and the Bride"
          className="w-full h-64 object-cover rounded-lg"
        />
        <img
          src="https://ik.imagekit.io/f9opvmhvz/Photo_65.png?updatedAt=1766170596963"
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-xl text-gray-700 mb-8 leading-relaxed">
          You’ve decided to tie the knot and get married in the sunshine and charm of Tampa, Florida. What an exciting choice! Now comes the part where romance meets real-life logistics. Between the licenses, timelines, and planning details, things can feel a little overwhelming. This guide is here to help you navigate your Tampa marriage smoothly, keeping it simple, affordable, and most importantly, true to you. We’ll also walk through important photography considerations so you can relive the day for years to come.
        </p>

        <h2 className="text-3xl font-light text-gray-900 mb-6">License</h2>

        <p className="mb-4">
          Let’s start with the legal must-haves. To get married in Tampa, both you and your partner must apply in person together for a marriage license at one of the Hillsborough County Clerk of Court locations. The main office is located at:
        </p>

        <ul className="space-y-2 mb-6 list-disc list-inside">
          <li>800 E. Twiggs Street, Room 101, Tampa, FL 33602</li>
          <li>Open Monday–Friday, 8 AM – 5 PM, excluding holidays</li>
          <li> Appointments are encouraged and can be made online through the Clerk’s official website. Plan for your visit to take about 30 minutes to an hour</li>
        </ul>
        ...
        <div className="bg-gray-50 p-6 rounded-lg mb-8">
          ...
          <p className="mb-4">Marriage license fees vary between $61 - $86 depending on the factors above. $86 for a standard marriage license and $61 with a certificate of completion for the premarital course. </p>
        ...
        <div className="mb-12">
          <img
            src="https://ik.imagekit.io/f9opvmhvz/Photo_63.png"
            alt="First Dance"
        ...
        <p className="mb-6">
          Tampa is a stunning place year-round, with each season offering something special. From golden sunsets over the bay and it's beaches to vibrant downtown streets, Tampa’s diverse backdrops and tropical climate create unforgettable moments no matter the month. Here’s a breakdown of what to expect during each season to help you choose the perfect time for your wedding:
        </p>
        ...
        <p className="mb-8">
          As far as timing goes, we always recommend 1.5-2 hours before sunset for best lighting. You can also have your photos taken at sunrise for maximum seclusion prior to your ceremony. Additionally, you can choose to break up your day into sunrise portraits, pre-sunset ceremony + sunset portraits.
        </p>

        {/* BnB Images */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          <img
            src="https://ik.imagekit.io/f9opvmhvz/Photo_66.png?updatedAt=1766131696960"
            alt="Wedding photo 1"
            className="w-full h-80 object-cover rounded-lg"
          />
          <img
            src="https://ik.imagekit.io/f9opvmhvz/Photo_59.png"
            alt="Wedding photo 2"
            className="w-full h-80 object-cover rounded-lg"
          />
          <img
            src="https://ik.imagekit.io/f9opvmhvz/Photo_134.png"
            alt="Wedding photo 3"
            className="w-full h-80 object-cover rounded-lg"
          />
          <img
            src="https://ik.imagekit.io/f9opvmhvz/Photo_67.png?updatedAt=1766132063929"
            alt="Wedding photo 4"
            className="w-full h-80 object-cover rounded-lg"
          />
        </div>
        ...
        <div className="space-y-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-700">
              This beautifully restored Craftsman style inn offers vintage charm and quiet luxury. Located in a walkable district near coffee shops and waterfront parks, it’s perfect for a romantic and private wedding. Some ceremony packages include an officiant, champagne flutes, light floral décor, and access to the home’s lovely common spaces and porches for photos.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          <img
            src="https://ik.imagekit.io/f9opvmhvz/Photo_52.png?updatedAt=1766186103394"
            alt="Wedding detail 1"
            className="w-full h-80 object-cover rounded-lg"
          />
          <img
            src="https://ik.imagekit.io/f9opvmhvz/Photo_135.png"
            alt="Wedding detail 2"
            className="w-full h-80 object-cover rounded-lg"
          />
          <img
            src="https://ik.imagekit.io/f9opvmhvz/Photo_136.png"
            alt="Wedding detail 3"
            className="w-full h-80 object-cover rounded-lg"
          />
          <img
            src="https://ik.imagekit.io/f9opvmhvz/Photo_57.png"
        ...
        <div className="space-y-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-700">
              Both options are directly next to each other and both include a lush property with beautiful oak trees, stone arches, draping Spanish moss and charming brick pavers. The Llambias House also offers a lush arbor, colonial balcony, spiraling brick pavers, and a fairy tale wishing well. Located near 7th Street - our number one favorite street to photograph on.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              Bold, vibrant, and full of Cuban influenced design. This boutique hotel blends tropical modernism with Ybor’s historical roots. Expect lush palm courtyards, mid-century touches, and moody lighting. Great for couples who want something trendy and editorial. Their restaurant and cocktail bar are perfect for a stylish post-ceremony toast or dinner.
            </p>
          </div>
        ...
        <div className="bg-gray-50 p-8 rounded-lg text-center">
          <p className="text-gray-700 mb-6">
            Ready to plan your perfect Tampa Bay wedding? Let's discuss how we can capture your special day in this vibrant and unforgettable city.
          </p>
          <Link
            to="/contact"
      ...
      <div className="flex justify-between items-center mt-16 pt-8 border-t border-gray-200">
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="font-medium"> Editorial Vibes in Tampa </div>
              </div>
            </Link>
            <Link
...
export default BlogPostWeddingPrepTampa
