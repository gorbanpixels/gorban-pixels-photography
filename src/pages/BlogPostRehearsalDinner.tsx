  ...
  return (
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <h1 className="text-4xl md:text-5xl font-light text-gray-900 mb-8 leading-tight">
        Rehearsal Dinner & Reception Venues and Photography Packages in Tampa, FL
      </h1>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <p className="mb-4">
          Bringing a photographer to your rehearsal dinner is a smart move and here’s why:
        </p>
        ...
        <ol className="space-y-4 mb-8 list-decimal list-inside">
          ...
          <li>
            <strong>Unexpected Moments:</strong> Some of the best, most emotional moments happen off-script. I’m always ready to catch those surprise gems on camera.
          </li>
        </ol>

        <p className="mb-12">
          In short, having a photographer at your rehearsal dinner not only preserves precious moments; it also makes the evening more enjoyable. And with our discounted add-on price, it's both meaningful and affordable.
        </p>
        ...
        <div className="space-y-8 mb-12">
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Armature Works</h3>
            <p className="text-gray-700">
              A stylish waterfront warehouse turned culinary destination. With industrial-chic interiors, exposed brick, and sweeping river views, it’s ideal for modern, editorial-style photos.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-3"> Museum of Fine Arts</h3>
            <p className="text-gray-700">
              This elegant waterfront museum offers classic architecture, curated galleries, and timeless ambiance which is perfect for refined group photos and intimate, artful moments.
            </p>
          </div>
        ...
        <div className="space-y-8 mb-12">
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-3"> Birchwood Canopy</h3>
            <p className="text-gray-700">
              Enjoy elevated rooftop dining with sweeping views of the St. Pete waterfront at Birchwood Canopy. This stylish venue offers chef curated small plates, fresh seafood, and handcrafted cocktails in a vibrant yet refined setting perfect for a chic rehearsal dinner just steps from the bay.
            </p>
          </div>
      ...
      <div className="flex justify-between items-center mt-16 pt-8 border-t border-gray-200">
        <Link
          to="/blog/elope-in-st-augustine-fl"
...
export default BlogPostRehearsalDinner
